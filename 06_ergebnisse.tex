...
\subsubsection*{Berechnung des Druckverlustbeiwert}
\begin{flalign}
...
\subsubsection*{Berechnung des $K_v$-Wertes}
\begin{flalign}
...
\begin{figure}[h!]
	\begin{center}
		...
		%Trend Muffe
		\addplot[red,mark=none,text mark as node=true,point meta=explicit symbolic,nodes near coords,solid][domain=0:100]{19.2319/(-0.4757+e^(-0.0074*x))-4.5172};
		\addplot[blue,mark=none,text mark as node=true,point meta=explicit symbolic,nodes near coords,solid][domain=0:100]{0.000829961*(1.161889742)^(x-1.358635786)};	
